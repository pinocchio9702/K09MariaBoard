...
public class MemberDTO {
	...
	/*
	 * 액션태그의 useBean을 통해 폼값을 한꺼번에 받기 위해서는 <form태그 하위<input의 name속성과 DTO객체의 맴버변수명이
	 * 반드시 일치해야 한다.
	 */
...
//getter/setter
	...
	/*
	 * Object클래스에 정의된 메소드로 객체를 문자열형태로 변환해서 반환해주는 역할을 한다. toString()을 오버라이딩하면 객체 자체를
	 * 그대로 println() 하는 것이 가능한다.
	 */
	@Override
